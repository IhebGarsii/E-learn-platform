...
function TagInput({ tags, onChange }: TagInputProps) {
  ...
  return (
    <div className="p-2 flex gap-2 flex-wrap  border-gray-500 px-4 py-2 rounded-lg shadow-sm border-2 border-blue-500 focus:ring-1 focus:ring-blue-500 placeholder-gray-400">
      {tags.map(({ id, text }) => (
